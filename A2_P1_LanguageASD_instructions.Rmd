...
ggplot(train, aes(VISIT, CHI_MLU, group = Diagnosis, color = Diagnosis))+
  geom_smooth(method = lm)+
  geom_point()
  

lmer(CHI_MLU ~ VISIT*Diagnosis) # Slope of visit will depend on diagnosis. Differ between ASD and TD.
